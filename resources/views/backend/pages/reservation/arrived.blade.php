                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name='arrived'>
                                                                    <option value="0" {{ ( $reservation->arrived == 0) ? 'selected' : '' }}>Not Arrived</option>
                                                                    <option value="1"{{ ( $reservation->arrived == 1) ? 'selected' : '' }}>Arrived</option>
                                ...
                                <td>  
                                    <div class="btn-group">
                                        <a href="{{ route('entryPass', $reservation->id) }}" class="btn btn-success btn-sm">Generate Pass</a>
