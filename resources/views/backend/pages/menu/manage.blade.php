                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Status</label>
                                                            <select name="status">
                                                                @foreach(App\Models\menu::orderBy('id','desc')->get() as $menu)   
                                                                <option value="1" {{ ( $menu->staus == 1) ? 'selected' : '' }}>Active</option>
                                                                <option value="0"{{ ( $menu->staus == 0) ? 'selected' : '' }}>Inactive</option>
                                                                @endforeach
